...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=412894522ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tables récentes" class="drop_button btn">Récentes</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestion_financiere&table=journal">`gestion_financiere`.`journal`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestion_financiere&table=compte_resultat">`gestion_financiere`.`compte_resultat`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ami&table=news">`ami`.`news`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ami&table=fichies">`ami`.`fichies`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bibiliotheque&table=biblio_model">`bibiliotheque`.`biblio_model`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ami&table=conseillers">`ami`.`conseillers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ami&table=com_au_comptes">`ami`.`com_au_comptes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ami&table=secretaires">`ami`.`secretaires`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ami&table=tresoriers">`ami`.`tresoriers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ami&table=notables">`ami`.`notables`</a></li></ul></div><div class="drop_list"><button title="Tables préférées" class="drop_button btn">Préférées</button><ul id="pma_favorite_list"><li class="warp_link">Pas de tables préférées.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="4c59286f425d4c55335b2a51505b6158">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Faire Entrée pour exécuter la requête                    </span>
                            ...
                            targetdb="gestion_financiere" targettable="journal">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `journal`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="gestion_financiere" targettable="journal">
                            <div class="action_content">
